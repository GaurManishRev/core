...
export class TransactionTypeFactory {
    ...
    public static create(data: ITransactionData): ITransaction {
        const instance: ITransaction = new (this.get(data.type, data.chainId) as any)() as ITransaction;
        instance.data = data;
    ...
    public static get(type: number, chainId?: number): TransactionConstructor {

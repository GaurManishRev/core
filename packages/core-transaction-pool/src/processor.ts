...
export class Processor implements TransactionPool.IProcessor {
        ...
        for (const transaction of transactions) {
            ...
            if (exists) {
                ...
                try {
                    ...
                    const handler = Handlers.Registry.get(transactionInstance.type, transactionInstance.chainId);
    ...
    private validateTransaction(transaction: Interfaces.ITransactionData): boolean {
        ...
        try {
            ...
            return Handlers.Registry.get(transaction.type, transaction.chainId).canEnterTransactionPool(
                transaction,
                this.pool,
                this,
            );
